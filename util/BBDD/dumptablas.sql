...
CREATE TABLE `cestas` (
  ...
  PRIMARY KEY (`idCesta`),
  KEY `fk_cestas` (`usuario`),
  CONSTRAINT `fk_cestas` FOREIGN KEY (`usuario`) REFERENCES `usuarios` (`usuario`)
...
CREATE TABLE `productos` (
  ...
  CONSTRAINT `chk_cantidad` CHECK (((`cantidad` >= _utf8mb4'0') and (`cantidad` <= _utf8mb4'99999'))),
...
-- Dump completed on 2023-11-21 17:50:30
